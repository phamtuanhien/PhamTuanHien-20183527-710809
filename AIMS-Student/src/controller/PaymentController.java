...
public class PaymentController extends BaseController {
	...
	public Map<String, String> payOrderByDomesticDebitCard(int amount, String contents, String domesticCardNumber,
														   String domesticHolderName, String domesticValidFromDate, String domesticIssuingBank) {
		Map<String, String> result = new Hashtable<String, String>();
		result.put("RESULT", "PAYMENT FAILED!");
		try {
			this.card = new DomesticDebitCard(domesticCardNumber, domesticHolderName, domesticIssuingBank, domesticValidFromDate);
